...
class User(models.Model):
    ...
    role = models.ForeignKey(to="Role", to_field="id", null=True, blank=True, on_delete=models.SET_NULL)
...
class Script(models.Model):
    ...
    author = models.ForeignKey(verbose_name="作者", to='User', to_field="id", null=True, blank=True,
